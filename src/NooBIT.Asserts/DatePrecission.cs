...
namespace NooBIT.Asserts
{
    public abstract class DatePrecision
    {
        ...
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, date.Month, date.Day, date.Hour, date.Minute, date.Second);
        }

        public class MinutePrecision : DatePrecision
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, date.Month, date.Day, date.Hour, date.Minute, 0);
        }

        public class HourPrecision : DatePrecision
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, date.Month, date.Day, date.Hour, 0, 0);
        }

        public class DayPrecision : DatePrecision
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, date.Month, date.Day, 0, 0, 0);
        }

        public class MonthPrecision : DatePrecision
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, date.Month, 0, 0, 0, 0);
        }

        public class YearPrecision : DatePrecision
        {
            public override DateTime Truncate(DateTime date) => new DateTime(date.Year, 0, 0, 0, 0, 0);
        }
    }
}
